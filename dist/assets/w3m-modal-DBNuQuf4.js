import{dZ as k,et as le,dk as c,dm as pe,d6 as v,d7 as V,da as f,db as g,dc as d,d9 as l,dK as $,dw as H,dL as u,d8 as me,ds as w,de as B,dI as U,ek as fe,e3 as F,dp as K,dT as A,dA as M,dh as we,dl as E,d$ as z,eh as oe,dJ as be,dg as ce,eu as ge,ev as ye}from"./index-BmcL_aSg.js";import{P as D}from"./index-BXS4EodP.js";import{S as ve}from"./SwapController-CHuWzCRT.js";const de={isUnsupportedChainView(){return c.state.view==="UnsupportedChain"||c.state.view==="SwitchNetwork"&&c.state.history.includes("UnsupportedChain")},async safeClose(){if(this.isUnsupportedChainView()){k.shake();return}if(await le.isSIWXCloseDisabled()){k.shake();return}(c.state.view==="DataCapture"||c.state.view==="DataCaptureOtpConfirm")&&pe.disconnect(),k.close()}},xe=v`
  :host {
    display: block;
