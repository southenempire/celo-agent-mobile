...
function ecdsa(Point2, hash, ecdsaOpts = {}) {
  ...
  const hmac4 = ecdsaOpts.hmac || ((key, ...msgs) => hmac(hash, key, concatBytes(...msgs)));
  const { Fp, Fn } = Point2;
...
var createBase58check = (sha2564) => chain(checksum(4, (data) => sha2564(sha2564(data))), base58);
...
var hmac3 = (hash, key, message) => new HMAC3(hash, key).update(message).digest();
hmac3.create = (hash, key) => new HMAC3(hash, key);
...
var SHA5123 = class extends HashMD3 {
  constructor(outputLen = 64) {
    super(128, outputLen, 16, false);
...
var sha2563 = createHasher4(() => new SHA2563());
...
*/
//# sourceMappingURL=chunk-WIYM2YWD.js.map
