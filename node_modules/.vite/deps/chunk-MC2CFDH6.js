...
var BlockchainApiController = {
  ...
  async fetchSwapQuote({ amount, userAddress, from: from3, to: to2, gasPrice }) {
    var _a;
    const isSupported = await BlockchainApiController.isNetworkSupported((_a = ChainController.state.activeCaipNetwork) == null ? void 0 : _a.caipNetworkId);
    if (!isSupported) {
      return { quotes: [] };
  ...
  async generateSwapCalldata({ amount, from: from3, to: to2, userAddress, disableEstimate }) {
    var _a;
    const isSupported = await BlockchainApiController.isNetworkSupported((_a = ChainController.state.activeCaipNetwork) == null ? void 0 : _a.caipNetworkId);
    if (!isSupported) {
  ...
  async generateApproveCalldata({ from: from3, to: to2, userAddress }) {
    var _a;
    const { st: st2, sv } = BlockchainApiController.getSdkProperties();
    const isSupported = await BlockchainApiController.isNetworkSupported((_a = ChainController.state.activeCaipNetwork) == null ? void 0 : _a.caipNetworkId);
    if (!isSupported) {
...
// node_modules/@walletconnect/ethereum-provider/node_modules/@reown/appkit-controllers/node_modules/@walletconnect/core/dist/index.es.js
...
var Us = class {
  ...
  process(e2, n2, r2 = false) {
    ...
    x = P3 >>> 13, P3 &= 8191, P3 += g * (5 * y4) + w * (5 * h4) + b * (5 * f5) + I2 * (5 * l3) + R3 * (5 * u2), x += P3 >>> 13, P3 &= 8191;
    ...
    x = J2 >>> 13, J2 &= 8191, J2 += g * f5 + w * l3 + b * u2 + I2 * a + R3 * c2, x += J2 >>> 13, J2 &= 8191, x = (x << 2) + x | 0, x = x + C4 | 0, C4 = x & 8191, x = x >>> 13, P3 += x, i3[0] = C4, i3[1] = P3, i3[2] = k2, i3[3] = M3, i3[4] = D, i3[5] = z, i3[6] = Z2, i3[7] = st2, i3[8] = W, i3[9] = J2;
  }
  finalize() {
...
function _s(t2, e2, n2, r2, o2, i3 = 20) {
  let s2 = t2[0], c2 = t2[1], a = t2[2], u2 = t2[3], l3 = e2[0], f5 = e2[1], h4 = e2[2], y4 = e2[3], E2 = e2[4], p = e2[5], d2 = e2[6], v = e2[7], m2 = o2, O2 = n2[0], N = n2[1], $ = n2[2], B3 = s2, A2 = c2, T = a, S2 = u2, L = l3, U4 = f5, _ = h4, j = y4, g = E2, w = p, b = d2, I2 = v, R3 = m2, x = O2, C4 = N, P3 = $;
  ...
  let k2 = 0;
  r2[k2++] = s2 + B3 | 0, r2[k2++] = c2 + A2 | 0, r2[k2++] = a + T | 0, r2[k2++] = u2 + S2 | 0, r2[k2++] = l3 + L | 0, r2[k2++] = f5 + U4 | 0, r2[k2++] = h4 + _ | 0, r2[k2++] = y4 + j | 0, r2[k2++] = E2 + g | 0, r2[k2++] = p + w | 0, r2[k2++] = d2 + b | 0, r2[k2++] = v + I2 | 0, r2[k2++] = m2 + R3 | 0, r2[k2++] = O2 + x | 0, r2[k2++] = N + C4 | 0, r2[k2++] = $ + P3 | 0;
}
...
*/
//# sourceMappingURL=chunk-MC2CFDH6.js.map
