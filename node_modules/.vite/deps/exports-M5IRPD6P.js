...
// node_modules/@reown/appkit-adapter-wagmi/node_modules/@wagmi/connectors/dist/esm/baseAccount.js
    ...
    async getProvider() {
      if (!walletProvider) {
        ...
        const { createBaseAccountSDK } = await (() => {
          try {
            return import("./dist-4IRH2XXZ.js");
          } catch {
...
// node_modules/@reown/appkit-adapter-wagmi/node_modules/@wagmi/connectors/dist/esm/coinbaseWallet.js
    ...
    async getProvider() {
      if (!walletProvider) {
        const { createCoinbaseWalletSDK } = await (() => {
          try {
            return import("./dist-GY3MSN4D.js");
          } catch {
...
// node_modules/@reown/appkit-adapter-wagmi/node_modules/@wagmi/connectors/dist/esm/metaMask.js
      ...
      async function initProvider() {
        ...
        const MetaMaskSDK = await (async () => {
          const { default: SDK } = await (() => {
            try {
              return import("./metamask-sdk-GGSBDQFB.js");
            } catch {
...
// node_modules/@reown/appkit-adapter-wagmi/node_modules/@wagmi/connectors/dist/esm/porto.js
...
// node_modules/@reown/appkit-adapter-wagmi/node_modules/@wagmi/connectors/dist/esm/safe.js
safe.type = "safe";
      ...
      if (!provider_) {
        ...
        const SafeAppProvider = await (async () => {
          const Provider = await (() => {
            try {
              return import("./dist-KQRYZ5RF.js");
            } catch {
...
// node_modules/@reown/appkit-adapter-wagmi/node_modules/@wagmi/connectors/dist/esm/version.js
var version = "7.2.1";

// node_modules/@reown/appkit-adapter-wagmi/node_modules/@wagmi/connectors/dist/esm/walletConnect.js
    ...
    async getProvider({ chainId } = {}) {
      ...
      async function initProvider() {
        ...
        const { EthereumProvider } = await (() => {
          try {
            return import("./index.es-BD3M3HNQ.js");
          } catch {
...
//# sourceMappingURL=exports-M5IRPD6P.js.map
