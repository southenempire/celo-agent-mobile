import {
  ...
  AppKitConnectButton,
  AppKitNetworkButton
} from "./chunk-JME4NJNO.js";
import "./chunk-4PTCKVH2.js";
import "./chunk-D2BNJKBN.js";
import "./chunk-OHCJKZGO.js";
import "./chunk-RARJH7GK.js";
import "./chunk-UMZWCOYG.js";
import "./chunk-D4WROQRU.js";
import "./chunk-46B57AFE.js";
import "./chunk-F52QGFMR.js";
import "./chunk-6UO2GQCB.js";
import "./chunk-6QOWD2HI.js";
import "./chunk-6LDGX7JV.js";
import "./chunk-NWWH6OHD.js";
import "./chunk-TR6KDB6V.js";
import "./chunk-ZMHK5BKH.js";
import "./chunk-D5LI66D5.js";
import "./chunk-LD4QFRZW.js";
import "./chunk-34STYSOX.js";
import "./chunk-LM3KCUMC.js";
import "./chunk-SGZQWGVL.js";
import "./chunk-FMCGGYK4.js";
import "./chunk-MPZV2LOP.js";
import "./chunk-HNB35IZC.js";
import "./chunk-7ZVZKP7H.js";
import "./chunk-HSKKM6WR.js";
import "./chunk-FS3CSUOV.js";
import "./chunk-2VPBIBMU.js";
import "./chunk-CGXHVTOC.js";
import "./chunk-G3RW6OSI.js";
import "./chunk-MQPBGXFE.js";
import "./chunk-AS3KT4WO.js";
import {
  setColorTheme,
  setThemeVariables
} from "./chunk-QMZOQUSB.js";
import "./chunk-TI7FWOOO.js";
import "./chunk-HIWEAIGI.js";
import "./chunk-HVEPSE7U.js";
import "./chunk-LQR2ZPSC.js";
import "./chunk-VTXAKH2H.js";
import {
  esm_default
...
function useAppKitAccount(options) {
  ...
  const allAccounts = connections.flatMap((connection) => {
    ...
    return caipNetwork ? connection.accounts.map(({ address, type, publicKey }) => CoreHelperUtil.createAccount({
...
function useAppKitWallets() {
  ...
  const [currentWcPayUrl, setCurrentWcPayUrl] = (0, import_react2.useState)(void 0);
  ...
  async function connect(_wallet, namespace, options) {
    setCurrentWcPayUrl(options == null ? void 0 : options.wcPayUrl);
    ...
    try {
      const walletConnector = _wallet == null ? void 0 : _wallet.connectors.find((c) => c.chain === activeNamespace);
      const connector = walletConnector && activeNamespace ? ConnectorController.getConnector({
        id: walletConnector == null ? void 0 : walletConnector.id,
        namespace: activeNamespace
      }) : void 0;
      const fallbackConnector = !connector && activeNamespace ? ConnectorController.getConnector({ id: _wallet == null ? void 0 : _wallet.id, namespace: activeNamespace }) : void 0;
      if ((_wallet == null ? void 0 : _wallet.isInjected) && connector) {
        ...
        if (wcWallet.mobile_link) {
          ConnectionControllerUtil.onConnectMobile(wcWallet, options == null ? void 0 : options.wcPayUrl);
        } else {
...
var UniversalAdapter = class extends AdapterBlueprint {
  ...
  async getAccounts({ namespace }) {
    ...
    const caipAccounts = (((_c = (_b = (_a = provider == null ? void 0 : provider.session) == null ? void 0 : _a.namespaces) == null ? void 0 : _b[namespace]) == null ? void 0 : _c.accounts) || []).filter((account, index, self) => self.indexOf(account) === index);
    return Promise.resolve({
...
var AppKitBaseClient = class {
  ...
  async initialize(options) {
    ...
    if (((_e = OptionsController.state.features) == null ? void 0 : _e.reownAuthentication) || ((_f = OptionsController.state.remoteFeatures) == null ? void 0 : _f.reownAuthentication)) {
      const { ReownAuthentication } = await import("./features-A6LISWCK.js");
  ...
  async openSend(args) {
    ...
    return new Promise((resolve, reject) => {
      ...
      const unsubscribeModal = ModalController.subscribe((modal3) => {
        if (!modal3.open) {
          cleanup();
  ...
  async initializeUniversalAdapter() {
    ...
    this.universalProvider = this.options.universalProvider ?? await C.init(universalProviderOptions);
...
var AppKit = class extends AppKitBaseClient {
  ...
  async loadModalComponents(features, remoteFeatures) {
    ...
    if (usingEmbeddedWallet) {
      featureImportPromises.push(import("./embedded-wallet-2GP4JIOR.js"));
    }
    if (remoteFeatures.email) {
      featureImportPromises.push(import("./email-3RTV7EK5.js"));
    }
    if (remoteFeatures.socials) {
      featureImportPromises.push(import("./socials-WHN3AJRF.js"));
    }
    if (remoteFeatures.swaps && remoteFeatures.swaps.length > 0) {
      featureImportPromises.push(import("./swaps-UMJAOGCZ.js"));
    }
    if (features.send) {
      featureImportPromises.push(import("./send-DGT6KLVQ.js"));
    }
    if (features.receive) {
      featureImportPromises.push(import("./receive-RX44YZCZ.js"));
    }
    if (remoteFeatures.onramp && remoteFeatures.onramp.length > 0) {
      featureImportPromises.push(import("./onramp-NPQ5SKAI.js"));
    }
    if (remoteFeatures.payWithExchange) {
      featureImportPromises.push(import("./pay-with-exchange-D3BEYLXA.js"));
    }
    if (remoteFeatures.activity) {
      featureImportPromises.push(import("./transactions-IRX377FQ.js"));
    }
    if (features.pay || remoteFeatures.payments) {
      featureImportPromises.push(import("./exports-K2QNHXUR.js"));
    }
    if (remoteFeatures.emailCapture) {
      featureImportPromises.push(import("./data-capture-PYBCFFJY.js"));
    }
    await Promise.all([
      ...featureImportPromises,
      import("./exports-2L6WTU62.js"),
      import("./w3m-modal-XSYISWBW.js")
    ]);
  }
};
